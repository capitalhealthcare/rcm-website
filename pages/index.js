...
const Index = () => {
  ...
  useEffect(() => {
    setShowPopup(true); // show popup when component mounts
  }, []);
            ...
            <div className="row align-items-center justify-content-center">
              ...
              <div className="col-lg-7">
                <div className="hero-img wow fadeInUp" data-wow-delay="0.3s">
                  <img src="assets/img/hero-img/hero.png" alt="Hero" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="about-text">
                  ...
                  <Link href="/about">
                    <a className="template-btn mt-40">
                      Download Brochure <i className="far fa-plus" />
                    </a>
                  </Link>
                </div>
              </div>
            ...
            <div className="row justify-content-center service-loop">
              <div className="col-lg-4 col-md-6 col-sm-8">
                ...
                >
                  ...
                  <h4 className="title">
                    <Link href="/service-details">
                      <a>Patient Appointment and Registration</a>
                    </Link>
                  </h4>
                  <p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-8">
                ...
                >
                  ...
                  <h4 className="title">
                    <Link href="/service-details">
                      <a>Patient Eligibility and Benefits</a>
                    </Link>
                  </h4>
                  <p>
                    Dolor sit amet consectetur ascing elitsed eiusmod tempor
